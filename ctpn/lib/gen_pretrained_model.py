...
import sys
sys.path.append('..')
import Net.test_net  as Net


def generate_VGG_16_model(net, output_path):
    vgg_16 = models.vgg16(pretrained=False)
    print(vgg_16)
    vgg_16.load_state_dict(torch.load('/home/zhangyangsong/OCR/MyCode/vgg16-397923af.pth'))
...
if __name__ == '__main__':
    generate_VGG_16_model(Net.CTPN(), './vgg16_new1.model')