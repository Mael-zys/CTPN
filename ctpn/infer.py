...
IMG_ROOT = "/home/zhangyangsong/OCR/ICDAR2015/test_im"
TEST_RESULT = './infer_resultICDAR'
THRESH_HOLD = 0.7
NMS_THRESH = 0.1
NEIGHBOURS_MIN_DIST = 50
MIN_ANCHOR_BATCH = 2
MODEL = './modelICDAR2015/ctpn-msra_ali-9-end.model'
...
def random_test(net):
    test_pair = gen_test_images(IMG_ROOT, 0)        ##获取测试文件，返回所有文件的路径的list
    print(test_pair)
